        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('total')
                    ...
                    ->prefix('Rp ')
                    ->numeric(),
                Tables\Columns\TextColumn::make('promo_discount')
                    ->label('Diskon Promo')
                    ->prefix('Rp ')
                    ->numeric()
                    ->badge()
            ...
            ->actions([
                Tables\Actions\Action::make('PrintBluetooth')
                    ...
                    ->action(function (Transaction $record, $livewire) {
                        $order = Transaction::with(['paymentMethod', 'transactionItems.product', 'member'])->findOrFail($record->id);
                    ...
                    ->color('info'),
                Tables\Actions\Action::make('PrintUSB')
                    ->label('Cetak (Cable)')
                    ...
                    ->action(function (Transaction $record, $livewire) {
                        ...
                        $livewire->dispatch('doPrintReceiptUSB', $receiptData);
                    })
                    ->icon('heroicon-o-printer')
                    ->color('amber'),
